POKEMON["Nosepass"] = {
    ...
    learnableTms = { TM_IDS.TOXIC, TM_IDS.PROTECT, TM_IDS.THUNDERBOLT, TM_IDS.THUNDER, TM_IDS.EARTHQUAKE, TM_IDS.DOUBLE_TEAM, TM_IDS.ROCK_TOMB, TM_IDS.REST, TM_IDS.EXPLOSION, TM_IDS.THUNDER_WAVE, TM_IDS.ROCK_SLIDE, TM_IDS.SUBSTITUTE },
