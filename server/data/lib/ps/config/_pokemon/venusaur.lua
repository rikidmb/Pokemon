POKEMON["Venusaur"] = {
    ...
    skills = { "Tackle", 1, "Headbutt", 5, "Razor Leaf", 10, "Vine Whip", 15, "Seed Bomb", 20, "Poison Powder", 25, "Sleep Powder", 30, "Synthesis", 40, "Solar Beam", 45, "Sludge Bomb", 50, "Petal Dance", 60, "Double-Edge", 65, "Petal Blizzard", 70, "Worry Seed", 75 },
