POKEMON["Seviper"] = {
    ...
    learnableTms = { TM_IDS.TOXIC, TM_IDS.PROTECT, TM_IDS.RAIN_DANCE, TM_IDS.EARTHQUAKE, TM_IDS.DOUBLE_TEAM, TM_IDS.FLAMETHROWER, TM_IDS.SLUDGE_BOMB, TM_IDS.REST, TM_IDS.POISON_JAB, TM_IDS.SUBSTITUTE },
