POKEMON["Swalot"] = {
    ...
    learnableTms = { TM_IDS.TOXIC, TM_IDS.ICE_BEAM, TM_IDS.PROTECT, TM_IDS.RAIN_DANCE, TM_IDS.SOLAR_BEAM, TM_IDS.SHADOW_BALL, TM_IDS.DOUBLE_TEAM, TM_IDS.SLUDGE_BOMB, TM_IDS.REST, TM_IDS.EXPLOSION, TM_IDS.DREAM_EATER, TM_IDS.SUBSTITUTE, TM_IDS.HYPER_BEAM, TM_IDS.EARTHQUAKE },
