POKEMON["Seedot"] = {
    ...
    learnableTms = { TM_IDS.TOXIC, TM_IDS.PROTECT, TM_IDS.SOLAR_BEAM, TM_IDS.SHADOW_BALL, TM_IDS.DOUBLE_TEAM, TM_IDS.REST, TM_IDS.ENERGY_BALL, TM_IDS.EXPLOSION, TM_IDS.SWORDS_DANCE, TM_IDS.SUBSTITUTE },
