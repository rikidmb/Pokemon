POKEMON["Test Smoochum"] = {
    pTypes = {ELEMENT_ICE, ELEMENT_PSYCHIC}, dexStorage = 10238, atk = 30, def = 15, spAtk = 85, spDef = 65, energy = 100, chance = 20, portrait = 17527, dexPortrait = 15885, fastcallPortrait = 16085, catchStorage = 16238,
