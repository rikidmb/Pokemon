POKEMON["Seel"] = {
    pTypes = {ELEMENT_WATER}, dexStorage = 10086, atk = 45, def = 55, spAtk = 45, spDef = 70, energy = 100, chance = 70, portrait = 12787, dexPortrait = 13587, fastcallPortrait = 10720, catchStorage = 16086,
    ...
    skills = {"Tackle", 1, "Headbutt", 5, "Icy Wind", 10, "Water Pulse", 15, "Rest", 20, "Aurora Beam", 25, "Ice Beam", 30, "Aqua Tail", 35},
    abilities = {POKEMON_ABILITIES.STRENGTH, POKEMON_ABILITIES.WATERFALL, "Headbutt", "Rock Smash"}, eggGroup = {POKEMON_EGG_GROUP_WATER_1, POKEMON_EGG_GROUP_FIELD}, eggId = 14014, eggChance = 20,
