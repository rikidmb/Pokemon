POKEMON["Dratini"] = {
    pTypes = {ELEMENT_DRAGON}, dexStorage = 10147, atk = 64, def = 45, spAtk = 50, spDef = 50, energy = 100, chance = 500, portrait = 12848, dexPortrait = 13648, fastcallPortrait = 10781, catchStorage = 16147,
    ...
    skills = {"Tackle", 1, "Slam", 5, "Thunder Wave", 10, "Twister", 15, "Dragon Tail", 20, "Agility", 25, "Aqua Tail", 30},
    abilities = {POKEMON_ABILITIES.WATERFALL, "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_WATER_1, POKEMON_EGG_GROUP_DRAGON}, eggId = 14047, eggChance = 1,
