POKEMON["Poliwhirl"] = {
    pTypes = {ELEMENT_WATER}, dexStorage = 10061, atk = 65, def = 65, spAtk = 50, spDef = 50, energy = 100, chance = 200, portrait = 12762, dexPortrait = 13562, fastcallPortrait = 10695, catchStorage = 16061,
    evolutions = {
    ...
    skills = {"Tackle", 1, "Bubble", 5, "Water Gun", 10, "Hypnosis", 15, "Double Slap", 20, "Bubblebeam", 25, "Wake-Up Slap", 35, "Mud Shot", 40, "Body Slam", 45},
    abilities = {POKEMON_ABILITIES.DIG, POKEMON_ABILITIES.STRENGTH, POKEMON_ABILITIES.WATERFALL, "Surf", "Dive", "Rock Smash", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_WATER_1}, eggId = 14003, eggChance = 20,
