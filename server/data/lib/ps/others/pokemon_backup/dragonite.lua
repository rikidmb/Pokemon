POKEMON["Dragonite"] = {
    pTypes = {ELEMENT_DRAGON, ELEMENT_FLYING}, dexStorage = 10149, atk = 134, def = 95, spAtk = 100, spDef = 100, energy = 100, chance = 800, portrait = 12850, dexPortrait = 13650, fastcallPortrait = 10783, catchStorage = 16149,
    evolutions = {},
    description = "It can fly in spite of its big and bulky physique. It circles the globe in just 16 hours.",
    skills = {"Tackle", 1, "Slam", 5, "Thunder Wave", 10, "Twister", 15, "Dragon Tail", 20, "Agility", 25, "Aqua Tail", 30, "Outrage", 40, "Hyper Beam", 45, "Fire Punch", 55, "Thunder Punch", 60, "Wing Attack", 65, "Dragon Dance", 70, "Hurricane", 75},
    abilities = {POKEMON_ABILITIES.WATERFALL, "Find", "Fly", "Rock Smash", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_WATER_1, POKEMON_EGG_GROUP_DRAGON}, eggId = 14047, eggChance = 1,
    specialAbilities = {POKEMON_SPECIAL_ABILITY_IDS.INNER_FOCUS},
    learnableTms = {TM_IDS.SOFTBOILED, TM_IDS.FLAMETHROWER, TM_IDS.AERIAL_ACE, TM_IDS.ROCK_TOMB, TM_IDS.WATER_PULSE, TM_IDS.FURY_CUTTER, TM_IDS.FIRE_PUNCH, TM_IDS.THUNDER_PUNCH, TM_IDS.ICE_PUNCH, TM_IDS.MUD_SLAP, TM_IDS.IRON_TAIL, TM_IDS.RAIN_DANCE, TM_IDS.ICY_WIND, TM_IDS.ZAP_CANNON, TM_IDS.HEADBUTT, TM_IDS.DYNAMIC_PUNCH, TM_IDS.EARTHQUAKE, TM_IDS.RAZOR_WIND, TM_IDS.TOXIC, TM_IDS.BODY_SLAM, TM_IDS.TAKE_DOWN, TM_IDS.DOUBLE_EDGE, TM_IDS.BUBBLEBEAM, TM_IDS.WATER_GUN, TM_IDS.ICE_BEAM, TM_IDS.BLIZZARD, TM_IDS.HYPER_BEAM, TM_IDS.RAGE, TM_IDS.DRAGON_RAGE, TM_IDS.THUNDERBOLT, TM_IDS.THUNDER, TM_IDS.MIMIC, TM_IDS.DOUBLE_TEAM, TM_IDS.REFLECT, TM_IDS.BIDE, TM_IDS.FIRE_BLAST, TM_IDS.SWIFT, TM_IDS.EGG_BOMB, TM_IDS.SKULL_BASH, TM_IDS.REST, TM_IDS.THUNDER_WAVE, TM_IDS.SUBSTITUTE},
