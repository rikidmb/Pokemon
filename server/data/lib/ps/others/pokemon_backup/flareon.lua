POKEMON["Flareon"] = {
    pTypes = {ELEMENT_FIRE}, dexStorage = 10136, atk = 130, def = 60, spAtk = 95, spDef = 110, energy = 100, chance = 500, portrait = 12837, dexPortrait = 13637, fastcallPortrait = 10770, catchStorage = 16136,
    evolutions = {},
    ...
    skills = {"Tackle", 1, "Quick Attack", 5, "Flamethrower", 10, "Ember", 15, "Bite", 20, "Fire Spin", 25, "Fire Fang", 35, "Lava Plume", 40, "Scary Face", 45, "Hyper Voice", 50, "Fire Blast", 55, "Sand-Attack", 60},
    abilities = {POKEMON_ABILITIES.DIG, POKEMON_ABILITIES.STRENGTH, "Find", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_FIELD}, eggId = 14044, eggChance = 1,
