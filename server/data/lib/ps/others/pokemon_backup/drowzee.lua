POKEMON["Drowzee"] = {
    pTypes = {ELEMENT_PSYCHIC}, dexStorage = 10096, atk = 48, def = 45, spAtk = 43, spDef = 90, energy = 100, chance = 200, portrait = 12797, dexPortrait = 13597, fastcallPortrait = 10730, catchStorage = 16096,
    ...
    skills = {"Tackle", 1, "Pound", 5, "Hypnosis", 10, "Dream Eater", 15, "Confusion", 20, "Headbutt", 25, "Psychic", 30, "Psybeam", 35},
    abilities = {"Blink", "Headbutt", "Teleport", "Flash"}, eggGroup = {POKEMON_EGG_GROUP_HUMAN_LIKE}, eggId = 14019, eggChance = 20,
