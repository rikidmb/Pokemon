POKEMON["Kangaskhan"] = {
    pTypes = {ELEMENT_NORMAL}, dexStorage = 10115, atk = 95, def = 80, spAtk = 40, spDef = 80, energy = 100, chance = 300, portrait = 12816, dexPortrait = 13616, fastcallPortrait = 10749, catchStorage = 16115,
    evolutions = {},
    description = "The female raises its offspring in a pouch on its belly. It is skilled at attacking using COMET PUNCH.",
    skills = {"Tackle", 1, "Bite", 5, "Double Hit", 10, "Sucker Punch", 15, "Stomp", 20, "Mega Punch", 25, "Dizzy Punch", 30, "Crunch", 35, "Outrage", 40, "Rage", 45, "Comet Punch", 50, "Reversal", 55},
    abilities = {POKEMON_ABILITIES.DIG, POKEMON_ABILITIES.ROCK_CLIMB, POKEMON_ABILITIES.STRENGTH, "Rock Smash", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_MONSTER}, eggId = 14031, eggChance = 5,
