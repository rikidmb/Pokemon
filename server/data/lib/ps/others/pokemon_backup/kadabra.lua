POKEMON["Kadabra"] = {
    pTypes = {ELEMENT_PSYCHIC}, dexStorage = 10064, atk = 35, def = 30, spAtk = 120, spDef = 70, energy = 100, chance = 300, portrait = 12765, dexPortrait = 13565, fastcallPortrait = 10698, catchStorage = 16064,
    ...
    skills = {"Tackle", 1, "Confusion", 5, "Calm Mind", 10, "Mist Ball", 15, "Recover", 20, "Disable", 25, "Psybeam", 35, "Psychic", 40, "Psycho Cut", 45},
