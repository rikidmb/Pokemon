POKEMON["Wigglytuff"] = {
    pTypes = {ELEMENT_NORMAL, ELEMENT_FAIRY}, dexStorage = 10040, atk = 70, def = 45, spAtk = 85, spDef = 50, energy = 100, chance = 350, portrait = 12741, dexPortrait = 13541, fastcallPortrait = 10674, catchStorage = 16040,
    evolutions = {},
    description = "Its fur is extremely fine, dense, and supple. The exquisitely pleasant fur conveys an image of luxury.",
    skills = {"Tackle", 1, "Pound", 5, "Sing", 10, "Body Slam", 15, "Disable", 20, "Wake-Up Slap", 25, "Rest", 30, "Mimic", 40, "Hyper Voice", 45, "Double-Edge", 50, "Defense Curl", 55},
    abilities = {POKEMON_ABILITIES.DIG, POKEMON_ABILITIES.STRENGTH, "Flash", "Rock Smash", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_FAIRY}, eggId = 13993, eggChance = 20,
