POKEMON["Grimer"] = {
    pTypes = {ELEMENT_POISON}, dexStorage = 10088, atk = 80, def = 50, spAtk = 40, spDef = 50, energy = 100, chance = 15, portrait = 12789, dexPortrait = 13589, fastcallPortrait = 10722, catchStorage = 16088,
    ...
    skills = {"Tackle", 1, "Sludge Wave", 5, "Acid Spray", 10, "Sludge", 15, "Poison Gas", 20, "Mud Bomb", 25, "Sludge Bomb", 30},
...
POKEMON["Christmas Grimer"].allowedBall = "christmas"