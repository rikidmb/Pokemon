POKEMON["Golem"] = {
    ...
    skills = { "Tackle", 1, "Rock Throw", 5, "Defense Curl", 10, "Magnitude", 15, "Rock Blast", 20, "Explosion", 25, "Earthquake", 35, "Rock Slide", 40, "Double-Edge", 45, "Stealth Rock", 55, "Rollout", 60 },
