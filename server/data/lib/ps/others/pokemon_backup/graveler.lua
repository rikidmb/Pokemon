POKEMON["Graveler"] = {
    pTypes = {ELEMENT_ROCK, ELEMENT_GROUND}, dexStorage = 10075, atk = 95, def = 115, spAtk = 45, spDef = 45, energy = 100, chance = 250, portrait = 12776, dexPortrait = 13576, fastcallPortrait = 10709, catchStorage = 16075,
    ...
    skills = {"Tackle", 1, "Rock Throw", 5, "Defense Curl", 10, "Magnitude", 15, "Rock Blast", 20, "Explosion", 25, "Earthquake", 35, "Rock Slide", 40, "Double-Edge", 45},
    abilities = {POKEMON_ABILITIES.DIG, POKEMON_ABILITIES.ROCK_CLIMB, POKEMON_ABILITIES.STRENGTH, "Rock Smash", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_MINERAL}, eggId = 14008, eggChance = 20,
