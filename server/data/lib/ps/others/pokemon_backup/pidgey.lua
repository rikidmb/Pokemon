POKEMON["Pidgey"] = {
    pTypes = {ELEMENT_NORMAL, ELEMENT_FLYING}, dexStorage = 10016, atk = 45, def = 40, spAtk = 35, spDef = 35, energy = 100, chance = 10, portrait = 12717, dexPortrait = 13517, fastcallPortrait = 10650, catchStorage = 16016,
    ...
    skills = {"Tackle", 1, "Sand-Attack", 5, "Gust", 10, "Quick Attack", 15, "Drill Peck", 20, "Hurricane", 25},
...
POKEMON["Christmas Pidgey"].allowedBall = "christmas"