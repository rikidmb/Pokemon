POKEMON["Vileplume"] = {
    pTypes = {ELEMENT_GRASS, ELEMENT_POISON}, dexStorage = 10045, atk = 80, def = 85, spAtk = 110, spDef = 90, energy = 100, chance = 400, portrait = 12746, dexPortrait = 13546, fastcallPortrait = 10679, catchStorage = 16045,
    evolutions = {},
    description = "Its petals are the largest in the world. It fiendishly scatters allergy-causing pollen from its petals.",
    skills = {"Tackle", 1, "Absorb", 5, "Acid", 10, "Acid Spray", 15, "Stun Spore", 20, "Sleep Powder", 25, "Giga Drain", 35, "Moonlight", 40, "Poison Powder", 45, "Venoshock", 55, "Aromatherapy", 60, "Petal Dance", 65, "Solar Beam", 70},
