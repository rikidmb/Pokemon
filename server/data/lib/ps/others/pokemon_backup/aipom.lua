POKEMON["Aipom"] = {
    pTypes = {ELEMENT_NORMAL}, dexStorage = 10190, atk = 70, def = 55, spAtk = 40, spDef = 55, energy = 100, chance = 50, portrait = 17479, dexPortrait = 15837, fastcallPortrait = 16037, catchStorage = 16190,
    evolutions = {},
    description = "It lives atop tall trees. When leaping from branch to branch, it deftly uses its tail for balance.",
    skills = {"Tackle", 1, "Scratch", 5, "Sand-Attack", 10, "Fury Swipes", 15, "Tickle", 20, "Swift", 25, "Agility", 30, "Double Hit", 35, "Nasty Plot", 40},
    abilities = {POKEMON_ABILITIES.DIG, POKEMON_ABILITIES.STRENGTH, "Find", "Cut", "Rock Smash", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_FIELD}, eggId = 17755, eggChance = 20,
