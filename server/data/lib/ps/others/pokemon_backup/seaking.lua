POKEMON["Seaking"] = {
    pTypes = {ELEMENT_WATER}, dexStorage = 10119, atk = 92, def = 65, spAtk = 65, spDef = 80, energy = 100, chance = 250, portrait = 12820, dexPortrait = 13620, fastcallPortrait = 10753, catchStorage = 16119,
    evolutions = {},
    description = "The horn on its head is sharp like a drill. It bores a hole in a boulder to make its nest.",
    skills = {"Tackle", 1, "Peck", 5, "Bubble", 10, "Horn Attack", 15, "Water Pulse", 20, "Water Gun", 25, "Megahorn", 30, "Aqua Ring", 40, "Supersonic", 45, "Horn Drill", 50, "Agility", 55},
    abilities = {POKEMON_ABILITIES.WATERFALL, "Surf", "Dive"}, eggGroup = {POKEMON_EGG_GROUP_WATER_2}, eggId = 14033, eggChance = 20,
