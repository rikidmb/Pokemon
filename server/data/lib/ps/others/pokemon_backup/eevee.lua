POKEMON["Eevee"] = {
    pTypes = {ELEMENT_NORMAL}, dexStorage = 10133, atk = 55, def = 50, spAtk = 45, spDef = 65, energy = 100, chance = 200, portrait = 12834, dexPortrait = 13634, fastcallPortrait = 10767, catchStorage = 16133,
    evolutions = {
    ...
    abilities = {POKEMON_ABILITIES.DIG, "Headbutt", "Find"}, eggGroup = {POKEMON_EGG_GROUP_FIELD}, eggId = 14044, eggChance = 1,
