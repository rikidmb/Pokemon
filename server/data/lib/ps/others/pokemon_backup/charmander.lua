POKEMON["Charmander"] = {
    ...
    skills = { "Tackle", 1, "Scratch", 5, "Ember", 10, "Slash", 15, "Scary Face", 20, "Fire Fang", 25, "Flamethrower", 30 },
...
POKEMON["Easter Charmander"].chance = 100
...
POKEMON["Christmas Charmander"].allowedBall = "christmas"
