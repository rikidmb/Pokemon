POKEMON["Nidoqueen"] = {
    pTypes = {ELEMENT_POISON, ELEMENT_GROUND}, dexStorage = 10031, atk = 92, def = 87, spAtk = 75, spDef = 85, energy = 100, chance = 500, portrait = 12732, dexPortrait = 13532, fastcallPortrait = 10665, catchStorage = 16031,
    evolutions = {},
    description = "The body is covered by stiff, needle-like scales. If it becomes excited, the needles bristle outwards.",
    skills = {"Tackle", 1, "Scratch", 5, "Double Kick", 10, "Poison Sting", 15, "Bite", 20, "Poison Fang", 25, "Fury Swipes", 35, "Crunch", 40, "Captivate", 45, "Acid", 50, "Body Slam", 60, "Earth Power", 65, "Skull Bash", 70, "Superpower", 75, "Stealth Rock", 80},
    abilities = {POKEMON_ABILITIES.DIG, POKEMON_ABILITIES.ROCK_CLIMB, POKEMON_ABILITIES.STRENGTH, "Rock Smash", "Headbutt"}, eggGroup = {}, eggId = 0, eggChance = 20,
