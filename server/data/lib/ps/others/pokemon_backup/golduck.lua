POKEMON["Golduck"] = {
    pTypes = {ELEMENT_WATER}, dexStorage = 10055, atk = 82, def = 78, spAtk = 95, spDef = 80, energy = 100, chance = 400, portrait = 12756, dexPortrait = 13556, fastcallPortrait = 10689, catchStorage = 16055,
    evolutions = {},
    description = "The forelegs are webbed, helping to make it an adept swimmer. It can be seen swimming elegantly in lakes, etc.",
    skills = {"Tackle", 1, "Scratch", 5, "Water Gun", 10, "Disable", 15, "Confusion", 20, "Water Pulse", 25, "Fury Swipes", 30, "Future Sight", 40, "Psychic", 45, "Hydro Pump", 50, "Amnesia", 55, "Psybeam", 60},
    abilities = {POKEMON_ABILITIES.DIG, POKEMON_ABILITIES.ROCK_CLIMB, POKEMON_ABILITIES.STRENGTH, POKEMON_ABILITIES.WATERFALL, "Surf", "Dive", "Rock Smash", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_WATER_1, POKEMON_EGG_GROUP_FIELD}, eggId = 14000, eggChance = 20,
