POKEMON["Rhyhorn"] = {
    pTypes = {ELEMENT_GROUND, ELEMENT_ROCK}, dexStorage = 10111, atk = 85, def = 95, spAtk = 30, spDef = 30, energy = 100, chance = 300, portrait = 12812, dexPortrait = 13612, fastcallPortrait = 10745, catchStorage = 16111,
    ...
    skills = {"Tackle", 1, "Horn Attack", 5, "Stomp", 10, "Rock Throw", 15, "Scary Face", 20, "Rock Blast", 25, "Earthquake", 30, "Drill Run", 35},
    abilities = {POKEMON_ABILITIES.DIG, POKEMON_ABILITIES.ROCK_CLIMB, POKEMON_ABILITIES.STRENGTH, "Rock Smash", "Ride", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_MONSTER, POKEMON_EGG_GROUP_FIELD}, eggId = 14028, eggChance = 20,
