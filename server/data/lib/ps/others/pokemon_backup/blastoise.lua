POKEMON["Blastoise"] = {
    pTypes = {ELEMENT_WATER}, dexStorage = 10009, atk = 83, def = 100, spAtk = 85, spDef = 105, energy = 100, chance = 800, portrait = 12710, dexPortrait = 13510, fastcallPortrait = 10643, catchStorage = 16009,
    evolutions = {},
    description = "It crushes its foe under its heavy body to cause fainting. In a pinch, it will withdraw inside its shell.",
    skills = {"Tackle", 1, "Bite", 5, "Bubble", 10, "Water Gun", 15, "Protect", 20, "Bubblebeam", 25, "Water Pulse", 30, "Aqua Tail", 40, "Hydro Pump", 45, "Flash Cannon", 55, "Rapid Spin", 60, "Hydro Cannon", 65, "Rain Dance", 70},
    abilities = {POKEMON_ABILITIES.DIG, POKEMON_ABILITIES.ROCK_CLIMB, POKEMON_ABILITIES.STRENGTH, POKEMON_ABILITIES.WATERFALL, "Surf", "Dive", "Rock Smash", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_MONSTER, POKEMON_EGG_GROUP_WATER_1}, eggId = 13980, eggChance = 20,
