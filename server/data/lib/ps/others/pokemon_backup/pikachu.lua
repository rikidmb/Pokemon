POKEMON["Pikachu"] = {
    pTypes = {ELEMENT_ELECTRIC}, dexStorage = 10025, atk = 55, def = 40, spAtk = 50, spDef = 50, energy = 100, chance = 150, portrait = 12726, dexPortrait = 13526, fastcallPortrait = 10659, catchStorage = 16025,
    ...
    skills = {"Tackle", 1, "Thunder Shock", 5, "Double Team", 10, "Quick Attack", 15, "Slam", 20, "Thunderbolt", 25, "Electro Ball", 30},
    abilities = {POKEMON_ABILITIES.DIG, POKEMON_ABILITIES.STRENGTH, "Flash", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_FIELD, POKEMON_EGG_GROUP_FAIRY}, eggId = 13987, eggChance = 20,
...
POKEMON["Easter Pikachu"].chance = 100
...
POKEMON["Christmas Pikachu"].allowedBall = "christmas"
