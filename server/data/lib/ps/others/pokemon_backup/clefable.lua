POKEMON["Clefable"] = {
    pTypes = {ELEMENT_FAIRY}, dexStorage = 10036, atk = 70, def = 73, spAtk = 95, spDef = 90, energy = 100, chance = 400, portrait = 12737, dexPortrait = 13537, fastcallPortrait = 10670, catchStorage = 16036,
    evolutions = {},
    description = "It has an acute sense of hearing. It can easily hear a pin being dropped nearly 1,100 yards away.",
    skills = {"Tackle", 1, "Pound", 5, "Double Slap", 10, "Sing", 15, "Wake-Up Slap", 20, "Metronome", 25, "Moonlight", 30, "Magical Leaf", 40, "Defense Curl", 45, "Healing Wish", 50, "Meteor Mash", 55},
    abilities = {POKEMON_ABILITIES.DIG, POKEMON_ABILITIES.STRENGTH, "Flash", "Rock Smash", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_FAIRY}, eggId = 13991, eggChance = 20,
