POKEMON["Meowth"] = {
    pTypes = {ELEMENT_NORMAL}, dexStorage = 10052, atk = 45, def = 35, spAtk = 40, spDef = 40, energy = 100, chance = 30, portrait = 12753, dexPortrait = 13553, fastcallPortrait = 10686, catchStorage = 16052,
    ...
    skills = {"Tackle", 1, "Scratch", 5, "Bite", 10, "Fury Swipes", 15, "Slash", 20, "Hypnosis", 25, "Night Slash", 30, "Iron Tail", 35},
...
POKEMON["Christmas Meowth"].allowedBall = "christmas"