POKEMON["Weezing"] = {
    pTypes = {ELEMENT_POISON}, dexStorage = 10110, atk = 90, def = 120, spAtk = 85, spDef = 70, energy = 100, chance = 350, portrait = 12811, dexPortrait = 13611, fastcallPortrait = 10744, catchStorage = 16110,
    evolutions = {},
    description = "Very rarely, a sudden mutation can result in two small KOFFING twins becoming conjoined as a WEEZING.",
    skills = {"Tackle", 1, "Smog", 5, "Poison Gas", 10, "Clear Smog", 15, "Smoke Screen", 20, "Explosion", 25, "Sludge", 30, "Venoshock", 40, "Screech", 45, "Double Hit", 50, "Mud Shot", 55, "Sludge Bomb", 60},
