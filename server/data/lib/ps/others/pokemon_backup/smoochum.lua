POKEMON["Smoochum"] = {
    pTypes = {ELEMENT_ICE, ELEMENT_PSYCHIC}, dexStorage = 10238, atk = 30, def = 15, spAtk = 85, spDef = 65, energy = 100, chance = 300, portrait = 17527, dexPortrait = 15885, fastcallPortrait = 16085, catchStorage = 16238,
    ...
    skills = {"Tackle", 1, "Pound", 5, "Lick", 10, "Sweet Kiss", 15, "Powder Snow", 20, "Confusion", 25},
    abilities = {"Flash"}, eggGroup = {}, eggId = 14037, eggChance = 0,
