POKEMON["Bulbasaur"] = {
    pTypes = {ELEMENT_GRASS, ELEMENT_POISON}, dexStorage = 10001, atk = 49, def = 49, spAtk = 65, spDef = 65, energy = 100, chance = 150, portrait = 12702, dexPortrait = 13502, fastcallPortrait = 10635, catchStorage = 16001,
    ...
    skills = {"Tackle", 1, "Headbutt", 5, "Razor Leaf", 10, "Vine Whip", 15, "Leech Seed", 20, "Poison Powder", 25, "Sleep Powder", 30},
...
POKEMON["Easter Bulbasaur"].chance = 100
