POKEMON["Togepi"] = {
    pTypes = {ELEMENT_FAIRY}, dexStorage = 10175, atk = 20, def = 65, spAtk = 40, spDef = 65, energy = 100, chance = 150, portrait = 17464, dexPortrait = 15822, fastcallPortrait = 16022, catchStorage = 16175,
    ...
    skills = {"Tackle", 1, "Metronome", 5, "Mirror Move", 10, "Wish", 15, "Ancient Power", 20, "Magic Coat", 25},
    abilities = {"Flash", "Headbutt"}, eggGroup = {}, eggId = 17749, eggChance = 0,
