POKEMON["Tangela"] = {
    pTypes = {ELEMENT_GRASS}, dexStorage = 10114, atk = 55, def = 115, spAtk = 100, spDef = 40, energy = 100, chance = 400, portrait = 12815, dexPortrait = 13615, fastcallPortrait = 10748, catchStorage = 16114,
    evolutions = {},
    description = "Blue plant vines cloak the POKEMON's identity in a tangled mass. It entangles anything that gets close.",
    skills = {"Tackle", 1, "Absorb", 5, "Constrict", 10, "Sleep Powder", 15, "Leaf Storm", 20, "Vine Whip", 25, "Mega Drain", 30, "Ancient Power", 35, "Stun Spore", 40, "Poison Powder", 45, "Wring Out", 50, "Power Whip", 55},
    abilities = {"Cut", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_GRASS}, eggId = 14030, eggChance = 10,
