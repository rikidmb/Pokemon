POKEMON["Dragonair"] = {
    pTypes = {ELEMENT_DRAGON}, dexStorage = 10148, atk = 84, def = 65, spAtk = 70, spDef = 70, energy = 100, chance = 500, portrait = 12849, dexPortrait = 13649, fastcallPortrait = 10782, catchStorage = 16148,
    ...
    skills = {"Tackle", 1, "Slam", 5, "Thunder Wave", 10, "Twister", 15, "Dragon Tail", 20, "Agility", 25, "Aqua Tail", 30, "Outrage", 40, "Hyper Beam", 45},
    abilities = {POKEMON_ABILITIES.WATERFALL, "Fly", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_WATER_1, POKEMON_EGG_GROUP_DRAGON}, eggId = 14047, eggChance = 1,
