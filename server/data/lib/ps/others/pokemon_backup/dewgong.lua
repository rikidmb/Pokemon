POKEMON["Dewgong"] = {
    pTypes = {ELEMENT_WATER, ELEMENT_ICE}, dexStorage = 10087, atk = 70, def = 80, spAtk = 70, spDef = 95, energy = 100, chance = 300, portrait = 12788, dexPortrait = 13588, fastcallPortrait = 10721, catchStorage = 16087,
    evolutions = {},
    description = "Its body is covered with a pure white fur. The colder the weather, the more active it becomes.",
    skills = {"Tackle", 1, "Headbutt", 5, "Icy Wind", 10, "Water Pulse", 15, "Rest", 20, "Aurora Beam", 25, "Ice Beam", 30, "Aqua Tail", 35, "Brine", 45, "Safeguard", 50, "Blizzard", 55, "Take Down", 60},
    abilities = {POKEMON_ABILITIES.STRENGTH, POKEMON_ABILITIES.WATERFALL, "Headbutt", "Surf", "Dive", "Rock Smash"}, eggGroup = {POKEMON_EGG_GROUP_WATER_1, POKEMON_EGG_GROUP_FIELD}, eggId = 14014, eggChance = 20, eggChance = 20,
