POKEMON["Raichu"] = {
    pTypes = {ELEMENT_ELECTRIC}, dexStorage = 10026, atk = 90, def = 55, spAtk = 90, spDef = 80, energy = 100, chance = 500, portrait = 12727, dexPortrait = 13527, fastcallPortrait = 10660, catchStorage = 16026,
    evolutions = {},
    ...
    skills = {"Tackle", 1, "Thunder Shock", 5, "Double Team", 10, "Quick Attack", 15, "Slam", 20, "Thunderbolt", 25, "Electro Ball", 30, "Thunder Wave", 40, "Agility", 45, "Discharge", 50, "Thunder", 55, "Charge", 60},
