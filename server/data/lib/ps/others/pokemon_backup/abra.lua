POKEMON["Abra"] = {
    pTypes = {ELEMENT_PSYCHIC}, dexStorage = 10063, atk = 20, def = 15, spAtk = 105, spDef = 55, energy = 100, chance = 100, portrait = 12764, dexPortrait = 13564, fastcallPortrait = 10697, catchStorage = 16063,
    ...
    skills = {"Tackle", 1, "Confusion", 5, "Calm Mind", 10, "Mist Ball", 15, "Recover", 20, "Disable", 25},
    abilities = {"Blink", "Flash", "Teleport", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_HUMAN_LIKE}, eggId = 14004, eggChance = 20,
...
POKEMON["Christmas Abra"].allowedBall = "christmas"