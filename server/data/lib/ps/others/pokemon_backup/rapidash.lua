POKEMON["Rapidash"] = {
    pTypes = {ELEMENT_FIRE}, dexStorage = 10078, atk = 100, def = 70, spAtk = 80, spDef = 80, energy = 100, chance = 400, portrait = 12779, dexPortrait = 13579, fastcallPortrait = 10712, catchStorage = 16078,
    evolutions = {},
    description = "It can gallop at a top speed of 150 miles per hour. It can race as fast as a bullet train while ablaze.",
    skills = {"Tackle", 1, "Ember", 5, "Flame Wheel", 10, "Stomp", 15,"Fire Spin", 20, "Take Down", 25, "Agility", 30, "Inferno", 40, "Captivate", 45, "Flame Burst", 50, "Fire Blast", 55, "Flare Blitz", 60, "Megahorn", 65},
    abilities = {POKEMON_ABILITIES.STRENGTH, "Ride", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_FIELD}, eggId = 14009, eggChance = 20,
