POKEMON["Wooper"] = {
    pTypes = {ELEMENT_WATER, ELEMENT_GROUND}, dexStorage = 10194, atk = 45, def = 45, spAtk = 25, spDef = 25, energy = 100, chance = 100, portrait = 17483, dexPortrait = 15841, fastcallPortrait = 16041, catchStorage = 16194,
    ...
    skills = {"Tackle", 1, "Water Gun", 5, "Mud Shot", 10, "Slam", 15, "Mud Bomb", 20, "Amnesia", 25, "Earthquake", 30},
    abilities = {POKEMON_ABILITIES.DIG, POKEMON_ABILITIES.WATERFALL, "Flash", "Surf", "Dive", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_WATER_1, POKEMON_EGG_GROUP_FIELD}, eggId = 17758, eggChance = 20,
