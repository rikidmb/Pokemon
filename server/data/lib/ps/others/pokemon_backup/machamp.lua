POKEMON["Machamp"] = {
    pTypes = {ELEMENT_FIGHT}, dexStorage = 10068, atk = 130, def = 80, spAtk = 65, spDef = 85, energy = 100, chance = 400, portrait = 12769, dexPortrait = 13569, fastcallPortrait = 10702, catchStorage = 16068,
    evolutions = {},
    description = "Its four ruggedly developed arms can launch a flurry of 1,000 punches in just two seconds.",
    skills = {"Tackle", 1, "Low Kick", 5, "Karate Chop", 10, "Seismic Toss", 15, "Cross Chop", 20, "Scary Face", 25, "Dynamic Punch", 35, "Wake-Up Slap", 40, "Focus Energy", 45, "Revenge", 55, "Vital Throw", 60, "Submission", 65},
    abilities = {POKEMON_ABILITIES.DIG, POKEMON_ABILITIES.ROCK_CLIMB, POKEMON_ABILITIES.STRENGTH, "Rock Smash", "Headbutt"}, eggGroup = {POKEMON_EGG_GROUP_HUMAN_LIKE}, eggId = 14005, eggChance = 20,
