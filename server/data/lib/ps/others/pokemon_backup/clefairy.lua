POKEMON["Clefairy"] = {
    pTypes = {ELEMENT_FAIRY}, dexStorage = 10035, atk = 45, def = 48, spAtk = 60, spDef = 65, energy = 100, chance = 80, portrait = 12736, dexPortrait = 13536, fastcallPortrait = 10669, catchStorage = 16035,
    ...
    skills = {"Tackle", 1, "Pound", 5, "Double Slap", 10, "Sing", 15, "Wake-Up Slap", 20, "Metronome", 25, "Moonlight", 30},
