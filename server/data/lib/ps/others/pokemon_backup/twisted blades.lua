POKEMON["Twisted Blades"] = { -- Scyther Boss
    pTypes = {ELEMENT_BUG, ELEMENT_FLYING}, dexStorage = 10123, atk = 110 * 6, def = 80 * 3, spAtk = 55 * 6, spDef = 80 * 3, energy = 100, chance = 600, portrait = 12824, dexPortrait = 13624, fastcallPortrait = 10757, catchStorage = 16123,
