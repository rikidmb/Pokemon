POKEMON["Lugia"] = {
    pTypes = {ELEMENT_PSYCHIC, ELEMENT_FLYING}, dexStorage = 10249, atk = 90, def = 130, spAtk = 90, spDef = 154, energy = 100, chance = 100000, portrait = 17538, dexPortrait = 15896, fastcallPortrait = 16096, catchStorage = 16249,
    evolutions = {},
    description = "It is said to be the guardian of the seas. It is rumored to have been seen on the night of a storm.",
    skills = {"Tackle", 1, "Gust", 5, "Rain Dance", 10, "Hydro Pump", 15, "Ancient Power", 20, "Safeguard", 25, "Recover", 30, "Future Sight", 35, "Calm Mind", 40, "Sky Attack", 45},
    abilities = {POKEMON_ABILITIES.STRENGTH, POKEMON_ABILITIES.WATERFALL, "Find", "Rock Smash", "Headbutt"}, eggGroup = {}, eggId = 0, eggChance = 0,
