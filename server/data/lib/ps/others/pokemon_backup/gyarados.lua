POKEMON["Gyarados"] = {
    pTypes = {ELEMENT_WATER, ELEMENT_FLYING}, dexStorage = 10130, atk = 125, def = 79, spAtk = 60, spDef = 100, energy = 100, chance = 800, portrait = 12831, dexPortrait = 13631, fastcallPortrait = 10764, catchStorage = 16130,
    evolutions = {},
    ...
    skills = {"Tackle", 1, "Bite", 5, "Headbutt", 10, "Thrash", 15, "Water Gun", 20, "Twister", 25, "Aqua Tail", 30, "Hydro Pump", 35, "Hydro Cannon", 40, "Rain Dance", 45, "Hyper Beam", 50},
    abilities = {POKEMON_ABILITIES.STRENGTH, POKEMON_ABILITIES.WATERFALL, "Headbutt", "Surf", "Dive", "Rock Smash"}, eggGroup = {POKEMON_EGG_GROUP_WATER_2, POKEMON_EGG_GROUP_DRAGON}, eggId = 14042, eggChance = 20,
