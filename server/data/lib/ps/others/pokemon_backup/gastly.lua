POKEMON["Gastly"] = {
    pTypes = {ELEMENT_GHOST, ELEMENT_POISON}, dexStorage = 10092, atk = 35, def = 30, spAtk = 100, spDef = 35, energy = 100, chance = 200, portrait = 12793, dexPortrait = 13593, fastcallPortrait = 10726, catchStorage = 16092,
    ...
    skills = {"Tackle", 1, "Lick", 5, "Hypnosis", 10, "Night Shade", 15, "Sucker Punch", 20, "Curse", 25, "Dream Eater", 30},
    abilities = {}, eggGroup = {POKEMON_EGG_GROUP_AMORPHOUS}, eggId = 14017, eggChance = 20,
...
POKEMON["Christmas Gastly"].allowedBall = "christmas"