POKEMON["Tentacruel"] = {
    pTypes = {ELEMENT_WATER, ELEMENT_POISON}, dexStorage = 10073, atk = 70, def = 65, spAtk = 80, spDef = 120, energy = 100, chance = 800, portrait = 12774, dexPortrait = 13574, fastcallPortrait = 10707, catchStorage = 16073,
    evolutions = {},
    description = "It has 80 tentacles that move about freely. They can sting, causing poisoning and sharp, stabbing pain.",
    skills = {"Tackle", 1, "Poison Sting", 5, "Acid", 10, "Supersonic", 15, "Bubblebeam", 20, "Water Pulse", 25, "Wrap", 30, "Wring Out", 40, "Barrier", 45, "Poison Jab", 50, "Hydro Pump", 55, "Sludge Wave", 60, "Acid Spray", 65},
    abilities = {POKEMON_ABILITIES.WATERFALL, "Surf", "Dive", "Cut"}, eggGroup = {POKEMON_EGG_GROUP_WATER_3}, eggId = 14007, eggChance = 20,
