POKEMON["Sandshrew"] = {
    pTypes = {ELEMENT_GROUND}, dexStorage = 10027, atk = 75, def = 85, spAtk = 20, spDef = 30, energy = 100, chance = 30, portrait = 12728, dexPortrait = 13528, fastcallPortrait = 10661, catchStorage = 16027,
    ...
    skills = {"Tackle", 1, "Defense Curl", 5, "Earth Power", 10, "Sand-Attack", 15, "Mud Shot", 20, "Rollout", 25, "Sand Tomb", 30, "Rock Slide", 35},
...
POKEMON["Christmas Sandshrew"].allowedBall = "christmas"